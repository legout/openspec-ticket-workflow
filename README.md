...
curl -fsSL https://raw.githubusercontent.com/legout/openspec-ticket-opencode-starter/v0.2.2/install.sh | bash
...
```bash
mkdir -p ~/.local/bin
curl -fsSL https://raw.githubusercontent.com/legout/openspec-ticket-opencode-starter/v0.2.2/os-tk -o ~/.local/bin/os-tk
